    ...
    <div class="sidebar-content flex-grow-1 overflow-auto mt-2">
        ...
        @if(auth()->user()->canAccessTeacher())
            ...
            <ul class="nav nav-pills flex-column mb-3">
                ...
                <li class="nav-item"><x-sidebar-item route="teacher.courses" icon="bi bi-mortarboard" title="Meus Cursos"/></li>
                <li class="nav-item"><x-sidebar-item route="teacher.disciplines" icon="bi bi-journal-text" title="Minhas Disciplinas"/></li>
            </ul>
        @endif
        ...
        @hasanyrole('admin|coordenador_geral|coordenador_adjunto_geral')
            ...
            <ul class="nav nav-pills flex-column mb-3">
                ...
                <li class="nav-item"><x-sidebar-item route="admin.students.index" icon="bi bi-people" title="Alunos"/></li>
            </ul>
        @endhasanyrole
