...
@section('title', 'Novo Registro de Frequ̻ncia')

@section('content')
<div class="container">
    <h3 class="mb-4"><i class="bi bi-plus-circle me-2"></i> Novo Registro de Frequ̻ncia</h3>
        ...
        <div class="card-body">
            <form action="{{ route('attendance.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="project_id" id="project_id" class="form-select" required>
                        ...
                        @foreach($projects as $project)
                            <option value="{{ $project->id }}" @selected((string) old('project_id', $activeProjectId) === (string) $project->id)>
                                {{ $project->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('attendance.index', ['project_id' => $activeProjectId, 'month' => $selectedMonth]) }}" class="btn btn-secondary">
